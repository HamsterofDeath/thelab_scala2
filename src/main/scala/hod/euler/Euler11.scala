...
object Euler11 {
  ...
  def main(args: Array[String]) {
    val numberBlock = "08 02 22 97 38 15 00 40 00 75 04 05 07 78 52 12 50 77 91 08 " +
    ...
    //parse the block
    val numbers = numberBlock.sliding(2, 3).map(_.toInt).toArray.grouped(20).toArray
